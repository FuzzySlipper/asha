...
fn presentation_rust_serialization_matches_ir_shape() {
    use protocol_presentation::{
        ...
        AnimationResolvedMotion, AnimationTransitionProjection, AudioBus, AudioClipRef,
        ...
        BillboardLayer, BillboardPatch, BillboardProjectionDiagnostic,
        BillboardProjectionDiagnosticCode, BillboardProjectionOp, BillboardProjectionReadout,
        BillboardTemplateArgument, BillboardTextureRef, ParticleAnchor, ParticleColorKey,
        ...
        ParticleProjectionReadout, ParticleScalarKey, ParticleSpriteRef, PresentationOp,
