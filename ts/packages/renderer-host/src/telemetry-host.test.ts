...
import {
  ...
  type AshaTelemetryOverlaySink,
} from './telemetry-host.js';

class FakeOverlaySink implements AshaTelemetryOverlaySink {
...
function frame(
  op: RuntimeProjectionFrame['presentation']['ops'][number]['op'],
