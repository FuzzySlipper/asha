...
export const CUSTOM_WIRE_SCHEMAS: Readonly<Record<string, CustomWireSchema>> = {
  ...
  GameplayPrefabPartInteractionRequest: object({
    ...
    role: STRING,
    maxDistanceMillimeters: NON_NEGATIVE_INTEGER,
    tick: NON_NEGATIVE_INTEGER,
    expectedRuntimeSessionHash: STRING,
  }),
  GameplayPrefabPartInteractionTargetRequest: object({
    actor: NON_NEGATIVE_INTEGER,
    role: STRING,
    maxDistanceMillimeters: NON_NEGATIVE_INTEGER,
    expectedRuntimeSessionHash: STRING,
  }),
  GameplayPrefabPartInteractionTargetReadout: object({
    actor: NON_NEGATIVE_INTEGER,
    role: STRING,
    eligible: BOOLEAN,
    instance: nullable(NON_NEGATIVE_INTEGER),
    target: nullable(NON_NEGATIVE_INTEGER),
    distanceMillimeters: nullable(NON_NEGATIVE_INTEGER),
    runtimeSessionHash: STRING,
  }),
  GameplayPrefabPartInteractionReceipt: object({
    ...
    distanceMillimeters: NON_NEGATIVE_INTEGER,
    eventHash: STRING,
