...
export declare const NATIVE_RUST_RUNTIME_BRIDGE_REQUIRED_METHODS: readonly ["initializeEngine", "loadWorldBundle", "getCompositionStatus", "createCamera", "applyCollisionConstrainedCameraInput", "loadFpsRuntimeSession", "readFpsRuntimeSession", "applyFpsPrimaryFire", "restartFpsRuntimeSession", "applyEnemyDirectNavMovement", "planVoxelConversion", "registerVoxelConversionSource", "previewVoxelConversion", "applyVoxelConversion", "exportVoxelConversionEvidence", "unloadWorld"];
