...
import { BrowserInputHost, ResolvedCameraNavigationConsumer, createRuntimeSessionFacade, } from './index.js';
...
void test('one resolved-input path switches FPS, orbit, and top-down without simultaneous controllers', () => {
    ...
    assert.throws(() => bridge.applyFirstPersonCameraInput({
        camera,
        tick: 2,
        input: {
            moveForward: 1,
...
//# sourceMappingURL=camera-modes.test.js.map