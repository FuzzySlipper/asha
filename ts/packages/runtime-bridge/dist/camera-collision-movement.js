...
function horizontalMovementBasis(yawDegrees) {
...
export function collisionCameraAttemptedPose(before, envelope) {
    ...
    const movementUp = envelope.movementMode === 'grounded' ? [0, 0, 0] : before.basis.up;
    const distance = f32(cameraInput.dtSeconds * cameraInput.moveSpeedUnitsPerSecond);
    const movement = (axis) => f32(f32(movementBasis.forward[axis] * cameraInput.moveForward) +
...
//# sourceMappingURL=camera-collision-movement.js.map