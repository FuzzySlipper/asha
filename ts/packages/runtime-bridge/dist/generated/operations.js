...
export const MANIFEST_OPERATIONS = [
    ...
    { manifestName: 'apply_time_control_command', facadeMethod: 'applyTimeControlCommand', surface: 'stable' },
    { manifestName: 'read_time_control_state', facadeMethod: 'readTimeControlState', surface: 'stable' },
    ...
    { manifestName: 'read_projection_frame', facadeMethod: 'readProjectionFrame', surface: 'stable' },
    ...
    { manifestName: 'configure_input_session', facadeMethod: 'configureInputSession', surface: 'stable' },
    { manifestName: 'apply_input_context_command', facadeMethod: 'applyInputContextCommand', surface: 'stable' },
    { manifestName: 'submit_raw_input', facadeMethod: 'submitRawInput', surface: 'stable' },
    { manifestName: 'replay_resolved_input_action', facadeMethod: 'replayResolvedInputAction', surface: 'stable' },
    { manifestName: 'read_input_context_state', facadeMethod: 'readInputContextState', surface: 'stable' },
    { manifestName: 'create_camera', facadeMethod: 'createCamera', surface: 'stable' },
    { manifestName: 'apply_camera_mode_command', facadeMethod: 'applyCameraModeCommand', surface: 'stable' },
    { manifestName: 'apply_camera_navigation_input', facadeMethod: 'applyCameraNavigationInput', surface: 'stable' },
    { manifestName: 'read_camera_controller_state', facadeMethod: 'readCameraControllerState', surface: 'stable' },
