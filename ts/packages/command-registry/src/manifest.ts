...
const contract = (exportName: 'ScreenPointToPickRayRequest' | 'VoxelCoord' | 'VoxelSelectionSnapshot' | 'VoxelCommand'): NonNullableSchemaShape => ({ kind: 'contract', ref: { package: '@asha/contracts', exportName } });
