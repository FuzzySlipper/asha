...
export type GameRuleEffectOp = {
    ...
    readonly kind: 'removeModifier';
    readonly opId: string;
    readonly modifierId: string;
    readonly tags: readonly string[];
} | {
    readonly kind: 'schedulePeriodicEffect';
    readonly opId: string;
    readonly modifierId: string;
    readonly cadence: GameRuleTickCadence;
    readonly duration: GameRuleDuration;
    readonly tags: readonly string[];
} | {
    readonly kind: 'cancelResolution';
    readonly opId: string;
    readonly reason: string;
    readonly tags: readonly string[];
} | {
    readonly kind: 'emitTrace';
    readonly opId: string;
