...
export function adaptParticleBurstToHitSparkDescriptor(input) {
    ...
    const anchor = descriptor.anchor.kind === 'world'
        ...
        : resolveAttachedParticleAnchor(descriptor.anchor.entity, descriptor.anchor.offset, input.resolveEntityPosition);
...
function resolveAttachedParticleAnchor(entity, offset, resolveEntityPosition) {
