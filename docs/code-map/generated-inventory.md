...
Committed path classes: 772 source; 27 generated source; 543 other; 0 build/cache/output.
...
| `protocol-entity-authoring` (contract-steward) | actual: `core-ids`<br>allowed: `core-ids` | 8/1 | none | `gameplay-runtime-host`, `protocol-codegen`, `protocol-project-content`, `rule-lifecycle`, `rule-project-bundle`, `runtime-bridge-api`, `svc-entity-authoring`, `svc-project-content` |
...
| `protocol-input` (contract-steward) | actual: none<br>allowed: none | 6/0 | none | `protocol-codegen`, `protocol-project-content`, `rule-input`, `rule-project-bundle`, `runtime-bridge-api`, `svc-project-content` |
...
| `rule-input` (rust-rule) | actual: `protocol-input`<br>allowed: `protocol-input` | 2/1 | none | `rule-project-bundle`, `runtime-bridge-api` |
| `rule-lifecycle` (rust-rule) | actual: `core-entity`, `core-ids`, `core-space`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-game-rules`, `rule-gameplay-fabric`, `svc-collision`, `svc-combat`, `svc-entity-authoring`, `svc-game-rules`, `svc-levelgen`, `svc-pathfinding`<br>allowed: `core-entity`, `core-ids`, `core-space`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-game-rules`, `rule-gameplay-fabric`, `svc-collision`, `svc-combat`, `svc-entity-authoring`, `svc-game-rules`, `svc-levelgen`, `svc-pathfinding` | 2/13 | none | `rule-project-bundle`, `runtime-bridge-api` |
...
| `rule-project-bundle` (rust-rule) | actual: `core-assets`, `core-entity`, `core-events`, `core-ids`, `core-math`, `core-scene`, `core-space`, `core-voxel`, `gameplay-module-sdk`, `protocol-diagnostics`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-input`, `protocol-project-bundle`, `protocol-project-content`, `protocol-voxel-annotation`, `rule-gameplay-fabric`, `rule-input`, `rule-lifecycle`, `rule-trigger-volume`, `rule-voxel-edit`, `svc-gameplay-fabric`, `svc-project-content`, `svc-serialization`, `svc-spatial`, `svc-volume`, `svc-voxel-annotation`<br>allowed: `core-assets`, `core-entity`, `core-events`, `core-ids`, `core-math`, `core-scene`, `core-space`, `core-voxel`, `gameplay-module-sdk`, `protocol-diagnostics`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-input`, `protocol-project-bundle`, `protocol-project-content`, `protocol-voxel-annotation`, `rule-gameplay-fabric`, `rule-input`, `rule-lifecycle`, `rule-trigger-volume`, `rule-voxel-edit`, `svc-gameplay-fabric`, `svc-project-content`, `svc-serialization`, `svc-spatial`, `svc-volume`, `svc-voxel-annotation` | 3/27 | none | `gameplay-runtime-host`, `runtime-bridge-api`, `scene-diagnostics`, `role:asha-demo`, `role:asha-testing`, `role:asha-rulebench` |
...
| `engine-rs/crates/rules/gameplay-runtime-host/src/project_admission.rs` | 1833 / 1400 / 1600 | rust-rule | global policy |
| `engine-rs/crates/rules/rule-lifecycle/src/lib.rs` | 1829 / 1400 / 1600 | rust-rule | global policy |
| `engine-rs/crates/services/svc-entity-authoring/src/lib.rs` | 1806 / 1400 / 1600 | rust-service | global policy |
| `engine-rs/crates/bridge/runtime-bridge-api/src/authority/runtime_bridge_impl.rs` | 1783 / 1570 / 1621 | rust-bridge | 2026-10-15 |
...
| `engine-rs/crates/bridge/runtime-bridge-api/src/authority/project_and_sources.rs` | 1611 / 1400 / 1600 | rust-bridge | global policy |
...
| `engine-rs/crates/protocol/protocol-codegen/src/source.rs` | 1571 / 1400 / 1600 | contract-steward | global policy |
